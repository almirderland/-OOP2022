...
//	CSCI0000 Neural Networks p_shamoi@kbtu.kz h_hiroharu@kbtu.kz  d.akhmetzhan@kbtu.kz
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, CreditOverFlow {
        ...
        Admin a1 = new Admin("Admin", "Admin", "22/02/1972", "8 707-222-22-22", "admin1@gmail.com", "12345"); 
        Database.users.add(a1); 
        
        Book b1 = new Book("Thomas Calculus", "B1", "Thomas");
        Book b2 = new Book("Grokaem algoritmy", "B2", "Bhargava");
